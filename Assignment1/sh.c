...
/* This function get the current path pointer, and return new string till the next ':' or EOF */
...
/* This function move the current path pointer to the next ':' or EOF */
